...
const Projects = () => {
    const data=[
        ...
        {name:"Geni",description:"Geni is a lightweight, template-driven infrastructure generation tool that simplifies the creation and management of Kubernetes resources, Helm charts, and Terraform files from a single declarative YAML configuration.",linkto:"https://github.com/AgathEmmanuel/geni"},
